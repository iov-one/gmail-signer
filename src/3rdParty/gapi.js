 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  var ia = /^(\/[a-zA-Z0-9_\-]+)+$/,
    ...
    qa = function (a) {
      ...
      e = T(a, "rs");
      a = T(a, "t");
      return { pathPrefix: b, version: c, g: d, j: e, l: a };
    },
    S = function (a) {
      ...
      if (e["::"] && b.length) {
        ...
        for (var f = null; (f = b.shift()); ) {
          ...
          var k = (a.length && a[a.length - 1]) || null,
            w = k;
          (k && k.hint == l) || ((w = { hint: l, i: [] }), a.push(w));
          w.i.push(f);
        }
        var y = a.length;
        if (1 < y) {
...
gapi.load("client", {
  ...
  _c: {
    jsl: {
      ...
      h:
        "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_US.3k1wIje1lec.O/am\u003dwQE/d\u003d1/ct\u003dzgms/rs\u003dAGLTcCNT4ir0QEJ6sXXAMZvqjav9vQSaLw/m\u003d__features__",
      u: "https://apis.google.com/js/api:client.js",
      hee: true,
      fp: "212560a0f9b088389d9a8c380a324ed5c7020092",
      dpo: false,
    },
    fp: "212560a0f9b088389d9a8c380a324ed5c7020092",
    annotation: [
